...
import { resolveLastModified } from './generation'
...
const previousIconifyJSON = await readFile(outputPath, 'utf8')
  .then(content => JSON.parse(content) as IconifyJSON)
  .catch(() => null)

iconifyJSON.lastModified = resolveLastModified(iconifyJSON, previousIconifyJSON, generatedAt)
